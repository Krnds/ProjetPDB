...
public class DownloadPDB {
	...
	//todo: Ne fonctionne pas, car si le fichier n'existe pas retourne une erreur ou sinon s'il existe, 
	//le remplace par un fichier vide.
	
	//There's an external library (Apache Commons I/O, class FileUtils, method copyURLToFile
...
public static void main(String[] args) {
    ...
    try {
        ...
        String s = "https://www.pdb.org/pdb/download/downloadFile.do?fileFormat=pdb&compression=NO&structureId=" + id; //File Location goes here
        ...
        String outputMacOS = "/Users/dias/eclipse-workspace/ProjetPDB/doc";
        File outputFile = new File(outputMacOS + id + ".cif");
